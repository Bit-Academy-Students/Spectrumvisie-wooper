    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="md:hidden hidden border-t border-gray-200 py-4 space-y-2" data-mobile-menu>
            ...
            <div class="space-y-1 px-2">
                <p class="text-xs font-semibold uppercase text-gray-500">Jouw Autisme</p>
                <a href="{{ url('/waarom-psycho-educatie') }}" class="block py-1 text-gray-700 hover:text-blue-600">
                    Waarom psycho-educatie?
                </a>
                <a href="{{ url('/alles-over-jouw-autisme') }}" class="block py-1 text-gray-700 hover:text-blue-600">
                    Alles over Jouw Autisme
                </a>
                <a href="{{ url('/autismepaspoort') }}" class="block py-1 text-gray-700 hover:text-blue-600">
                    Autismepasspoort
                </a>
                <a href="{{ url('/accreditaties') }}" class="block py-1 text-gray-700 hover:text-blue-600">
                    Accreditaties
                </a>
                <a href="{{ url('/over-suzanne-rouwhorst') }}" class="block py-1 text-gray-700 hover:text-blue-600">
                    Over Suzanne Rouwhorst
                </a>
                <a href="{{ url('/veelgestelde-vragen') }}" class="block py-1 text-gray-700 hover:text-blue-600">
                    Veelgestelde vragen
                </a>
            </div>

            <div class="space-y-1 px-2">
                <p class="text-xs font-semibold uppercase text-gray-500">Trainers</p>
                <a href="{{ url('/word-trainer') }}" class="block py-1 text-gray-700 hover:text-blue-600">
                    Word trainer
                </a>
                <a href="{{ url('/trainers-info') }}" class="block py-1 text-gray-700 hover:text-blue-600">
                    Informatie voor trainers
                </a>
            </div>

            <a href="{{ url('/bestellen') }}" class="block px-2 py-1 text-gray-700 hover:text-blue-600">
                Bestellen
            </a>
            <a href="{{ url('/winkel') }}" class="block px-2 py-1 text-gray-700 hover:text-blue-600">
                Winkel
            </a>
            <a href="{{ url('/nieuws') }}" class="block px-2 py-1 text-gray-700 hover:text-blue-600">
                Nieuws
            </a>
            <a href="{{ url('/contact') }}" class="block px-2 py-1 text-gray-700 hover:text-blue-600">
                Contact
            </a>
