<header class="sticky top-0 z-50 bg-white border-b border-gray-200">
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex flex-1 justify-center">
                <div class="flex items-center gap-8 text-sm">
                    ...
                    <a href="{{ url('/kennisbank') }}" class="text-gray-700 hover:text-blue-600 transition-colors">
                        Boeken
                    </a>

                    <a href="{{ url('/reviews') }}" class="text-gray-700 hover:text-blue-600 transition-colors">
                        Reviews
                    </a>

                    @if (Auth::user())
                    @if (Auth::user()->role_id == 1)
                    <a href="{{ url('/admin/dashboard') }}" class="block px-2 py-1 text-gray-700 hover:text-blue-600">
                        Dashboard
                    </a>
                    @endif
                    @endif
                ...
                <div class="relative">
                    <button type="button"
                        ...
                        <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M6 20a6 6 0 1 1 12 0H6z" />
                        </svg>
                    </button>

                    <div class="hidden absolute right-0 mt-2 w-44 rounded-md bg-white shadow-lg ring-1 ring-black/5 py-1 text-sm" data-user-menu>
                        @guest
        ...
        <div class="md:hidden hidden border-t border-gray-200 py-4 space-y-2" data-mobile-menu>
            ...
            <a href="{{ url('/kennisbank') }}" class="block px-2 py-1 text-gray-700 hover:text-blue-600">
                Kennisbank
            </a>
            ...
            <div class="border-t border-gray-200 pt-3 mt-2 px-2">
                ...
                <form method="POST" action="{{ route('logout') }}" class="block w-full text-left">
                    @csrf
                    <button type="submit" class="py-1 text-gray-700 hover:text-blue-600">
                        Uitloggen
                    </button>
                </form>
                @endauth
